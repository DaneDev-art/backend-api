// =============================================
// controllers/cinetpayController.js ✅ Version corrigée finale
// =============================================
    ...
    try {
      ...
      if (!clientId) {
        ...
        return res.status(500).json({
          error:
            "Impossible de déterminer l'utilisateur connecté (clientId manquant)",
        });
      }
      ...
      if (seller.role && seller.role.toLowerCase() !== "seller") {
        return res
          .status(400)
          .json({ error: "Ce compte n’est pas un vendeur valide" });
      }

      console.log("🧩 Vérification vendeur: ✅ trouvé");
